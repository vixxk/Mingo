...
class AuthController {
    ...
    try {
      const { name, username, phone, otp, gender, dob, language, avatarIndex } = req.body;
      const result = await AuthService.signup({ name, username, phone, otp, gender, dob, language, avatarIndex });
